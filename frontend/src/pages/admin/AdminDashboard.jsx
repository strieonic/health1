...
const AdminDashboard = () => {
  ...
  const filteredPatients = patients.filter(p =>
    ...
    p.arogyamId?.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const filteredRecords = records.filter(r =>
    ...
    r.patient?.arogyamId?.toLowerCase().includes(searchQuery.toLowerCase()) ||
              ...
              <tbody>
                {filteredPatients.map((p, i) => (
                  ...
                  >
                    ...
                    <td><code style={{ fontSize: '12px', background: 'var(--accent-primary-soft)', color: 'var(--accent-primary)', padding: '3px 10px', borderRadius: '4px', fontWeight: 600 }}>{p.arogyamId || '—'}</code></td>
                    <td>{p.phone}</td>
                    <td>{p.bloodGroup || '—'}</td>
              ...
              <tbody>
                {filteredRecords.map((r, i) => (
                  ...
                  >
                    ...
                    <td><code style={{ fontSize: '12px', background: 'var(--accent-primary-soft)', color: 'var(--accent-primary)', padding: '3px 10px', borderRadius: '4px', fontWeight: 600 }}>{r.patient?.arogyamId ?? '—'}</code></td>
